...
TEST(LogConceptsTest, LogCategoryUsage)
{
    ...
    EXPECT_NE(category2.name(), category1.name());
}
...
{
    static_assert(LogVerbosityLevel<LogVerbosity::NoLogging>);
    static_assert(LogVerbosityLevel<LogVerbosity::Display>);
    static_assert(LogVerbosityLevel<LogVerbosity::Error>);
    static_assert(LogVerbosityLevel<LogVerbosity::Warning>);
    static_assert(LogVerbosityLevel<LogVerbosity::Fatal>);
    static_assert(LogVerbosityLevel<LogVerbosity::Log>);
}